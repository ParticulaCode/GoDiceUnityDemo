...
namespace FrostLib.Signals.impl
{
    ...
    public class Signal<T, U> : BaseSignal
    {
        ...
        public override List<Type> GetTypes()
        {
            return new List<Type> {typeof(T), typeof(U)};
        }
    ...
    public class Signal<T, U, V> : BaseSignal
    {
        ...
        public override List<Type> GetTypes()
        {
            return new List<Type> {typeof(T), typeof(U), typeof(V)};
        }
    ...
    public class Signal<T, U, V, W> : BaseSignal
    {
        ...
        public override List<Type> GetTypes()
        {
            return new List<Type> {typeof(T), typeof(U), typeof(V), typeof(W)};
        }
